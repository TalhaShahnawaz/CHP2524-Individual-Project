...
class FoodController extends Controller
{
    ...
    public function approvedfoodShow()
    {
        $food = Food::all();
        return view('admin.foodShow',['food'=>$food]);
    }
    ...
    public function approve(Request $request)
    {
        ...
        $foodToDelete = Food::find($request->id); // find the patient to delete by id
        $foodToDelete->delete(); // delete the record from the database

       
        return redirect('/foodShow')->with('message','Updated Sucessfully');
    }
    /**
