...
class BloodController extends Controller
{
    ...
    public function approvedbloodShow()
    {
        $blood = Blood::all();
    ...
    public function approve(Request $request)
    {
        ...
        $blood->selectDate = $request->selectDate;
        $blood->description = $request->description;
        $blood->bloodGroup = $request->description;

        $blood->save();

        $bloodToDelete = Blood::find($request->id); // find the patient to delete by id
        $bloodToDelete->delete(); // delete the record from the database

        return redirect('/bloodShow')->with('message','Updated Sucessfully');
    }
