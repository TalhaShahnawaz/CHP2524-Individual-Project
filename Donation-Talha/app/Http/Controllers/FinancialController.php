...
class FinancialController extends Controller
{
    ...
    public function approve(Request $request)
    {
        ...
        $financialToDelete = Financial::find($request->id); // find the patient to delete by id
        $financialToDelete->delete(); // delete the record from the database
        return redirect('/financialShow')->with('message','Updated Sucessfully');
