...
class EventOrganizeController extends Controller
{
    ...
    public function myEvent()
    {
        ...
        return view('Patient.myEvent',['eveMy'=>$myEv]);
    }

    public function eventProfileNog($id)
    {
        
        $profilePatient = OrganizeEvent::find($id);
        return view('Patient.PatientProfile',['pro_eve'=>$profilePatient]);
    }
