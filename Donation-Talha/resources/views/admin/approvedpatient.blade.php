            ...
            <table class="table table-light table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-danger">{{$patients->firstName}}</td>
                        <td class="border-bottom-danger">{{$patients->lastName}}</td>
                        <td class="border-bottom-danger">{{$patients->mobilePhone}}</td>
                        <td class="border-bottom-danger">{{$patients->email}}</td>
                        <td class="border-bottom-danger">
                            <a href="{{url('/deleteapprovedpatient',$patients->id)}}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>     
                    @endforeach
                </tbody>
